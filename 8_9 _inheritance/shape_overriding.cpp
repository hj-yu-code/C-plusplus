/*
일반적인 도형을 의미하는 Point(좌표값 저장)클래스와
사각형을 의미하는 Rectangle(좌표,가로,세로) 클래스,
원을 의미하는 Circle(좌표,반지름)클래스를 정의한다.

사각형과 원은 도형의 일종이므로
Point클래스와 상속관계를 구성한다.
...
int main()
{
	...
	// Point* p1 = new Rectangle(200, 100, 50, 50); // 기반 클래스를 호출 >> 가상함수 필요
	// p1->Draw();
...
Shape	[(4000)	(5000)	()		()		()		() ... ()]
	...
	5000
*/
	// Point *Shape = new Point; // 기반 클래스 객체 생성 불가 (순수 가상함수)
	Point *Shape[10] = { NULL };
